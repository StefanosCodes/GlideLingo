...
| 1. Domain/policy/identity | Complete | `c454ef4d616de809e00c9a9624636e714a6379f8` | `d0b951751882fa709ae5774a6feeddd778fc07cd` | `npm run verify:full-stack` at the immutable feature commit; 30 marketplace client tests within 97 passing client tests; 10 marketplace unit tests within 128 passing API tests; 6 marketplace PostgreSQL tests within 19 passing integration tests; Expo Doctor 21/21; desktop export emitted both protected tutor routes; negative ownership, capability, self-review, stale-version, policy-immutability, payout-readiness, audit, DDL, and direct-publication checks passed | None for Milestone 1; keep both flags off and add a safe public projection only when Milestone 2 implements discovery against real publication eligibility |
| 2. Discovery/manual availability | Not started | — | — | — | — |
| 3. Google free/busy | Not started | — | — | — | — |
| 4. Messaging/coordination | Not started | — | — | — | — |
| 5. Booking/checkout | Not started | — | — | — | — |
| 6. Completion/money/reviews | Not started | — | — | — | — |
